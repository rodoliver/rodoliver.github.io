...
Fig 4. Example of selecting the *Add User* button and the modal form.

![screenshot](images/MyWebsite_Project_Vehicle_info.png)  
Fig 5. Example of selecting the *Add Vehicle Information* button and the modal form.

![screenshot](images/MyWebsite_Project_Vehice_Maintenance.png)  
Fig 6. Example of selecting the *Vehicle Maintenance* button and the modal form.
...
Fig 8. Example of selecting the *Fuel Information* button and the modal form.
